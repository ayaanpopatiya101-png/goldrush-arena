...
const s = StyleSheet.create({
  ...
  streakMsg: { color: '#C8820A', fontFamily: 'Exo2_700Bold', fontSize: 22, letterSpacing: 2, textAlign: 'center', textShadowColor: '#C8820A', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 16 },
  streakSub: { color: '#FFFFFF88', fontFamily: 'Exo2_500Medium', fontSize: 13, marginBottom: 4 },
  ...
  dayIcon: { fontFamily: 'Exo2_700Bold', fontSize: 12 },
  dayReward: { fontFamily: 'Exo2_500Medium', fontSize: 8 },
  ...
  rewardLabel: { color: '#C8820A', fontFamily: 'Exo2_700Bold', fontSize: 10, letterSpacing: 2 },
  rewardCoins: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  coinEmoji: { fontSize: 28 },
  coinAmount: { color: '#C8820A', fontFamily: 'Exo2_700Bold', fontSize: 28 },
  ...
  claimText: { color: '#080814', fontFamily: 'Exo2_700Bold', fontSize: 16, letterSpacing: 1.5 },
  skipBtn: { paddingVertical: 6 },
  skipText: { color: '#FFFFFF44', fontFamily: 'Exo2_500Medium', fontSize: 12 },
});
