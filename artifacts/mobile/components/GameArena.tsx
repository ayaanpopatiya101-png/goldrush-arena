...
const s = StyleSheet.create({
  ...
  powerupLabel: { fontFamily:'Exo2_700Bold', fontSize:9, letterSpacing:0.5 },
  ...
  elimX:   { fontFamily:'Exo2_700Bold', fontSize:12 },
  modeBadge: { position:'absolute', top:6, right:6, borderRadius:8, borderWidth:1, paddingHorizontal:7, paddingVertical:3 },
  modeBadgeText: { fontFamily:'Exo2_700Bold', fontSize:9, letterSpacing:0.5 },
  duelTimer: { position:'absolute', top:6, left:0, right:0, alignItems:'center' },
  duelTimerText: { fontFamily:'Exo2_700Bold', fontSize:11, letterSpacing:1 },
  announcerWrap: { position:'absolute', top:'42%', left:0, right:0, alignItems:'center' },
  announcerText: { color:'#C8820A', fontSize:19, fontFamily:'Exo2_700Bold', letterSpacing:1.5, textShadowColor:'#C8820A', textShadowOffset:{width:0,height:0}, textShadowRadius:14 },
  comboWrap: { position:'absolute', top:'30%', left:0, right:0, alignItems:'center' },
  comboText: { fontFamily:'Exo2_700Bold', fontSize:22, letterSpacing:2, textShadowColor:'#FF6B35', textShadowOffset:{width:0,height:0}, textShadowRadius:18 },
  ...
  countdownText: { color:'#C8820A', fontSize:78, fontFamily:'Exo2_700Bold', textShadowColor:'#C8820A', textShadowOffset:{width:0,height:0}, textShadowRadius:28 },
  countdownSub:  { color:'#FFFFFF88', fontFamily:'Exo2_500Medium', fontSize:13, letterSpacing:1 },
  ...
  spectatorTitle: { color:'#FF4757', fontFamily:'Exo2_700Bold', fontSize:22, letterSpacing:2 },
  spectatorSub:   { color:'#FFFFFF88', fontFamily:'Exo2_400Regular', fontSize:12, textAlign:'center', lineHeight:17 },
  spectatorRewards: { flexDirection:'row', gap:20, marginVertical:4 },
  rewardItem: { color:'#C8820A', fontFamily:'Exo2_700Bold', fontSize:16 },
  collectBtn: { backgroundColor:'#C8820A', borderRadius:12, paddingHorizontal:28, paddingVertical:13, width:'100%', alignItems:'center' },
  collectBtnText: { color:'#080814', fontFamily:'Exo2_700Bold', fontSize:16, letterSpacing:1 },
  keepWatchBtn: { paddingVertical:6 },
  keepWatchText: { color:'#FFFFFF55', fontFamily:'Exo2_500Medium', fontSize:12 },
});
