...
const il = StyleSheet.create({
  ...
  zoneLabel: {
    ...
    fontFamily: 'Exo2_700Bold', fontSize: 9, letterSpacing: 1.5, color: '#FFD70066',
  },
  stageRow: { flexDirection: 'row', gap: 12, alignItems: 'flex-end', marginBottom: 16 },
  stageBox: { alignItems: 'center', gap: 4 },
  stageText: { fontFamily: 'Exo2_700Bold', fontSize: 11, color: '#FFFFFF88', letterSpacing: 1 },
  stageDotsRow: { flexDirection: 'row', gap: 4 },
  stageDot: { width: 10, height: 10, borderRadius: 5 },
  livesRow: { flexDirection: 'row', gap: 6 },
  heart: { width: 14, height: 14, borderRadius: 7 },
  livesLabel: { fontFamily: 'Exo2_600SemiBold', fontSize: 10, color: '#FFFFFF44', marginTop: 8, letterSpacing: 1 },
  ...
  pupLabel: { fontFamily: 'Exo2_700Bold', fontSize: 10, letterSpacing: 0.5 },
  ...
  rankDot: {},
  rankName: { fontFamily: 'Exo2_700Bold', letterSpacing: 0.3 },
  streakCol: { gap: 7, width: '100%', paddingHorizontal: 12 },
  streakRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  streakLabel: { fontFamily: 'Exo2_400Regular', fontSize: 10, width: 50 },
  streakBar: { height: 16, borderRadius: 6, borderWidth: 1, minWidth: 10 },
  streakMult: { fontFamily: 'Exo2_700Bold', fontSize: 12, width: 38, textAlign: 'right' },
  ...
  relicCardName: { fontFamily: 'Exo2_700Bold', fontSize: 9, letterSpacing: 0.3 },
  relicEffectBadge: { borderRadius: 6, paddingHorizontal: 5, paddingVertical: 2 },
  relicEffectText: { fontFamily: 'Exo2_700Bold', fontSize: 8 },
  readyBotRow: { flexDirection: 'row', alignItems: 'center', gap: 16, marginTop: 8 },
  readyVs: { fontFamily: 'Exo2_700Bold', fontSize: 20, letterSpacing: 2 },
  readyPractice: { fontFamily: 'Exo2_700Bold', fontSize: 10, letterSpacing: 2, color: '#FFFFFF44', marginTop: 8 },
});
...
const s = StyleSheet.create({
  ...
  skipText: { fontFamily: 'Exo2_700Bold', fontSize: 11, color: '#FFFFFF55', letterSpacing: 1 },
  stepCounter: {
    fontFamily: 'Exo2_600SemiBold', fontSize: 11, color: '#FFFFFF33',
  ...
  title: { fontFamily: 'Exo2_700Bold', fontSize: 17, letterSpacing: 0.2 },
  subtitle: { fontFamily: 'Exo2_500Medium', fontSize: 12, color: '#FFFFFF55', marginTop: 2 },
  body: { fontFamily: 'Exo2_400Regular', fontSize: 14, color: '#E0DCB8', lineHeight: 22 },
  ...
  nextText: { fontFamily: 'Exo2_700Bold', fontSize: 14, color: '#0A0700', letterSpacing: 1 },
});
