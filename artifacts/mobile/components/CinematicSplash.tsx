...
const styles = StyleSheet.create({
  ...
  particle:     { position: 'absolute', backgroundColor: '#FFD700' },
  logoWrap:     { width: 96, height: 96, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  logoGlow:     { position: 'absolute', width: 96, height: 96, borderRadius: 48, backgroundColor: '#FFD700', shadowColor: '#FFD700', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 1, shadowRadius: 40 },
  logoText:     { fontFamily: 'Inter_700Bold', fontSize: 42, color: '#FFD700', letterSpacing: 4, zIndex: 1, textShadowColor: '#FFD700', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 20 },
  divider:      { height: 1.5, backgroundColor: '#FFD70088', borderRadius: 1 },
  titleRow:     { flexDirection: 'row', flexWrap: 'nowrap' },
  titleLetter:  { fontFamily: 'Inter_700Bold', fontSize: Platform.OS === 'web' ? 22 : 24, color: '#FFFFFF', letterSpacing: 3, textShadowColor: '#FFD700', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 8 },
  subtitle:     { fontFamily: 'Inter_500Medium', fontSize: 11, color: '#FFFFFF66', letterSpacing: 2 },
  seasonBadge:  { marginTop: 4, backgroundColor: '#FFD70022', borderRadius: 20, borderWidth: 1, borderColor: '#FFD70055', paddingHorizontal: 14, paddingVertical: 5 },
  seasonText:   { fontFamily: 'Inter_700Bold', fontSize: 10, color: '#FFD700', letterSpacing: 1.5 },
});
