...
const styles = StyleSheet.create({
  ...
  logoText:     { fontFamily: 'Exo2_700Bold', fontSize: 42, color: '#C8820A', letterSpacing: 4, zIndex: 1, textShadowColor: '#C8820A', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 20 },
  divider:      { height: 1.5, backgroundColor: '#C8820A88', borderRadius: 1 },
  titleRow:     { flexDirection: 'row', flexWrap: 'nowrap' },
  titleLetter:  { fontFamily: 'Exo2_700Bold', fontSize: Platform.OS === 'web' ? 22 : 24, color: '#FFFFFF', letterSpacing: 3, textShadowColor: '#C8820A', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 8 },
  subtitle:     { fontFamily: 'Exo2_500Medium', fontSize: 11, color: '#FFFFFF66', letterSpacing: 2 },
  ...
  seasonText:   { fontFamily: 'Exo2_700Bold', fontSize: 10, color: '#C8820A', letterSpacing: 1.5 },
});
