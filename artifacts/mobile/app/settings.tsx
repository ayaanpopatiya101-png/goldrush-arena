...
const s = StyleSheet.create({
  ...
  title:     { fontFamily: 'Exo2_700Bold', fontSize: 16, letterSpacing: 2, color: '#F0F0FF' },
  section:   { gap: 10 },
  sectionTitle: { fontFamily: 'Exo2_600SemiBold', fontSize: 11, letterSpacing: 1.5, color: '#FFFFFF55', paddingLeft: 4 },
  ...
  rowTitle:  { fontFamily: 'Exo2_600SemiBold', fontSize: 14, color: '#F0F0FF' },
  rowSub:    { fontFamily: 'Exo2_400Regular', fontSize: 11, color: '#FFFFFF55', marginTop: 2 },
  ...
  accountName: { fontFamily: 'Exo2_700Bold', fontSize: 15, color: '#F0F0FF' },
  accountSub:  { fontFamily: 'Exo2_400Regular', fontSize: 11, color: '#FFFFFF55', marginTop: 2 },
  accountStats: { alignItems: 'center', gap: 2, minWidth: 38 },
  accountStatVal: { fontFamily: 'Exo2_700Bold', fontSize: 15, color: '#C8820A' },
  accountStatLbl: { fontFamily: 'Exo2_400Regular', fontSize: 9, color: '#FFFFFF44', letterSpacing: 0.5 },
  ...
  sensBtnLabel: { fontFamily: 'Exo2_700Bold', fontSize: 13, color: '#FFFFFF66' },
  sensBtnDesc:  { fontFamily: 'Exo2_400Regular', fontSize: 9, color: '#FFFFFF33', textAlign: 'center' },
  aboutRow:  { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 12 },
  aboutLabel:{ fontFamily: 'Exo2_400Regular', fontSize: 13, color: '#FFFFFF55' },
  aboutValue:{ fontFamily: 'Exo2_600SemiBold', fontSize: 13, color: '#F0F0FF' },
});
