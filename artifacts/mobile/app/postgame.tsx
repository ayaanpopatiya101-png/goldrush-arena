...
const styles = StyleSheet.create({
  ...
  positionText: { fontFamily: 'Exo2_700Bold', fontSize: 14, letterSpacing: 3 },
  resultText: { fontFamily: 'Exo2_700Bold', fontSize: 34, letterSpacing: 4 },
  victoryEmoji: { fontSize: 40, marginTop: 4 },
  statsCard: { borderRadius: 16, borderWidth: 1, padding: 16, gap: 12 },
  statsTitle: { fontFamily: 'Exo2_600SemiBold', fontSize: 11, letterSpacing: 1.5 },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  statItem: { flex: 1, minWidth: '40%', alignItems: 'center', gap: 2 },
  statValue: { fontFamily: 'Exo2_700Bold', fontSize: 24 },
  statLabel: { fontFamily: 'Exo2_500Medium', fontSize: 11 },
  xpCard: { borderRadius: 16, borderWidth: 1, padding: 14, gap: 8 },
  xpHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  xpLabel: { fontFamily: 'Exo2_600SemiBold', fontSize: 13, flex: 1 },
  rankUpBadge: { fontFamily: 'Exo2_700Bold', fontSize: 10, borderWidth: 1, borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2 },
  xpTrack: { height: 8, borderRadius: 4, overflow: 'hidden' },
  xpFill: { height: '100%', borderRadius: 4 },
  xpSub: { fontFamily: 'Exo2_400Regular', fontSize: 11 },
  achieveCard: { borderRadius: 14, borderWidth: 1.5, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 10, overflow: 'hidden' },
  achieveTitle: { color: '#FFFFFF88', fontFamily: 'Exo2_500Medium', fontSize: 11 },
  achieveName: { fontFamily: 'Exo2_700Bold', fontSize: 14 },
  ...
  lvlLabel: { fontFamily: 'Exo2_600SemiBold', fontSize: 11, letterSpacing: 1.5 },
  lvlDeltaBadge: { borderRadius: 8, borderWidth: 1, paddingHorizontal: 8, paddingVertical: 3 },
  lvlDeltaText: { fontFamily: 'Exo2_700Bold', fontSize: 13 },
  lvlBefore: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  lvlNum: { fontFamily: 'Exo2_700Bold', fontSize: 22 },
  lvlStable: { fontFamily: 'Exo2_400Regular', fontSize: 13 },
  lvlSuffix: { fontFamily: 'Exo2_400Regular', fontSize: 12 },
  ...
  playAgainText: { color: '#080814', fontFamily: 'Exo2_700Bold', fontSize: 16, letterSpacing: 1 },
  ...
  bonusTitle:     { fontFamily: 'Exo2_700Bold', fontSize: 10, letterSpacing: 1.2 },
  bonusRows:      { gap: 8 },
  bonusRow:       { flexDirection: 'row', alignItems: 'center', gap: 8 },
  bonusIcon:      { fontSize: 16, width: 22, textAlign: 'center' },
  bonusLabel:     { flex: 1, fontFamily: 'Exo2_400Regular', fontSize: 13 },
  bonusMult:      { fontFamily: 'Exo2_700Bold', fontSize: 13 },
  bonusTotalRow:  { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, paddingTop: 8, marginTop: 2 },
  bonusTotalLabel:{ fontFamily: 'Exo2_600SemiBold', fontSize: 12 },
  bonusTotalMult: { fontFamily: 'Exo2_700Bold', fontSize: 15 },
  streakText: { textAlign: 'center', fontFamily: 'Exo2_600SemiBold', fontSize: 14 },
});
