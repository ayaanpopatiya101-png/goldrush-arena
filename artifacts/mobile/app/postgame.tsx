...
const styles = StyleSheet.create({
  ...
  lvlNum: { fontFamily: 'Inter_700Bold', fontSize: 24 },
  ...
  playAgainGrad: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 18, gap: 10 },
  playAgainText: { color: '#080814', fontFamily: 'Inter_700Bold', fontSize: 17, letterSpacing: 1 },
