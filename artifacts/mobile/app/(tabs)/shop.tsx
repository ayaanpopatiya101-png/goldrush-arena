...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Inter_700Bold', fontSize: 24, letterSpacing: 2 },
  coinDisplay: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#C8820A1A', borderRadius: 12, borderWidth: 1, borderColor: '#C8820A44', paddingHorizontal: 10, paddingVertical: 6 },
  coinAmount: { color: '#FFB830', fontFamily: 'Inter_700Bold', fontSize: 15 },
  ...
  skinInfo: { padding: 12, gap: 4 },
  skinName: { fontFamily: 'Inter_700Bold', fontSize: 14 },
  ...
  bundleIcon: { width: 52, height: 52, borderRadius: 26, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  buyBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 10, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 7 },
  buyBtnText: { fontFamily: 'Inter_700Bold', fontSize: 14 },
  ...
  creditsValue: { color: '#B9A0E0', fontFamily: 'Inter_700Bold', fontSize: 24 },
});
