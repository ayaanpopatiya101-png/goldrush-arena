...
const GLOBAL_LEADERS = [
  { name: 'NightViper', rank: 'Spartan',    wins: 2847, xp: 52000, level: 48, color: '#C8820A' },
  { name: 'CrystalX',   rank: 'Spartan',    wins: 2614, xp: 48500, level: 46, color: '#B9F2FF' },
  { name: 'Inferno_K',  rank: 'General',    wins: 1990, xp: 38200, level: 41, color: '#FF4757' },
  { name: 'ZeroGravity',rank: 'General',    wins: 1823, xp: 34700, level: 39, color: '#FF6B35' },
  { name: 'Blaze_99',   rank: 'Lieutenant', wins: 1450, xp: 28000, level: 33, color: '#FF4757' },
  { name: 'IceQueen',   rank: 'Commander',  wins: 1380, xp: 25600, level: 30, color: '#00BFFF' },
  { name: 'Venom_X',    rank: 'General',    wins: 1270, xp: 22100, level: 27, color: '#00FF88' },
  { name: 'ShadowFX',   rank: 'Commander',  wins: 1100, xp: 19800, level: 24, color: '#9B59B6' },
  { name: 'PulseWave',  rank: 'Commander',  wins: 980,  xp: 17600, level: 21, color: '#FF00FF' },
  { name: 'NeonBlitz',  rank: 'Lieutenant', wins: 870,  xp: 15200, level: 18, color: '#FF6B35' },
];

const REGIONAL_LEADERS: Record<string, Array<{name:string;rank:string;wins:number;level:number;color:string}>> = {
  NA: [
    { name: 'NightViper',  rank: 'Spartan',    wins: 2847, level: 48, color: '#C8820A' },
    { name: 'Blaze_99',    rank: 'Lieutenant', wins: 1450, level: 33, color: '#FF4757' },
    { name: 'Venom_X',     rank: 'General',    wins: 1270, level: 27, color: '#00FF88' },
    { name: 'DarkRift',    rank: 'Commander',  wins: 940,  level: 22, color: '#8B8B8B' },
    { name: 'StormBreaker',rank: 'Sergeant',   wins: 620,  level: 14, color: '#C8820A' },
  ],
  EU: [
    { name: 'CrystalX',   rank: 'Spartan',    wins: 2614, level: 46, color: '#B9F2FF' },
    { name: 'IceQueen',   rank: 'Commander',  wins: 1380, level: 30, color: '#00BFFF' },
    { name: 'ShadowFX',   rank: 'Commander',  wins: 1100, level: 24, color: '#9B59B6' },
    { name: 'Ghostline',  rank: 'Lieutenant', wins: 880,  level: 20, color: '#FFFFFF88' },
    { name: 'VoidWalker', rank: 'Sergeant',   wins: 560,  level: 13, color: '#8800FF' },
  ],
  APAC: [
    { name: 'Inferno_K',  rank: 'General',    wins: 1990, level: 41, color: '#FF4757' },
    { name: 'PulseWave',  rank: 'Commander',  wins: 980,  level: 21, color: '#FF00FF' },
    { name: 'PixelHawk',  rank: 'Lieutenant', wins: 810,  level: 19, color: '#00E5FF' },
    { name: 'NeonSword',  rank: 'Sergeant',   wins: 540,  level: 12, color: '#C8820A' },
    { name: 'AstroKid',   rank: 'Corporal',   wins: 280,  level: 7,  color: '#C0C0C0' },
  ],
  LATAM: [
    { name: 'ZeroGravity',rank: 'General',    wins: 1823, level: 39, color: '#FF6B35' },
    { name: 'NeonBlitz',  rank: 'Lieutenant', wins: 870,  level: 18, color: '#FF6B35' },
    { name: 'TigerKing',  rank: 'Sergeant',   wins: 620,  level: 15, color: '#C8820A' },
    { name: 'LatinFury',  rank: 'Corporal',   wins: 390,  level: 9,  color: '#C0C0C0' },
    { name: 'DragonX',    rank: 'Private',    wins: 180,  level: 4,  color: '#CD7F32' },
  ],
};

const SEASON_LEADERS = [
  { name: 'NightViper',  rank: 'Spartan',    wins: 187, level: 48, color: '#C8820A' },
  { name: 'ZeroGravity', rank: 'General',    wins: 164, level: 39, color: '#FF6B35' },
  { name: 'CrystalX',   rank: 'Spartan',    wins: 159, level: 46, color: '#B9F2FF' },
  { name: 'Blaze_99',   rank: 'Lieutenant', wins: 143, level: 33, color: '#FF4757' },
  { name: 'Venom_X',    rank: 'General',    wins: 138, level: 27, color: '#00FF88' },
  { name: 'IceQueen',   rank: 'Commander',  wins: 121, level: 30, color: '#00BFFF' },
  { name: 'DarkMatter', rank: 'Lieutenant', wins: 98,  level: 20, color: '#8B8B8B' },
  { name: 'PulseWave',  rank: 'Commander',  wins: 87,  level: 21, color: '#FF00FF' },
];
