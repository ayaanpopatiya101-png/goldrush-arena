...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Exo2_700Bold', fontSize: 16, letterSpacing: 2 },
  modeBadge:   { borderRadius: 8, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 2 },
  modeBadgeText: { fontFamily: 'Exo2_700Bold', fontSize: 10, letterSpacing: 1.5 },
  content: { paddingHorizontal: 20, paddingBottom: 40, gap: 20 },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 8 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  statusText: { fontFamily: 'Exo2_500Medium', fontSize: 13 },
  section: { gap: 10 },
  sectionHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  sectionTitle: { fontFamily: 'Exo2_600SemiBold', fontSize: 11, letterSpacing: 1.5 },
  playersList: { gap: 8 },
  emptySlot: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 14, borderRadius: 14, borderWidth: 1, borderStyle: 'dashed' },
  emptyText: { fontFamily: 'Exo2_500Medium', fontSize: 13 },
  mapCard: { width: 132, padding: 12, borderRadius: 14, borderWidth: 1.5, gap: 5, overflow: 'hidden' },
  mapIcon: { fontSize: 26 },
  mapName: { fontFamily: 'Exo2_700Bold', fontSize: 13 },
  mapDesc: { fontFamily: 'Exo2_400Regular', fontSize: 10, lineHeight: 13, minHeight: 39 },
  ...
  mapBadgeText: { fontFamily: 'Exo2_700Bold', fontSize: 9, color: '#0D0A06', letterSpacing: 0.5 },
  ...
  countdownText: { color: '#C8820A', fontSize: 96, fontFamily: 'Exo2_700Bold', textShadowColor: '#C8820A', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 30 },
});
