...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Inter_700Bold', fontSize: 18, letterSpacing: 2 },
  ...
  mapCard: { width: 140, padding: 14, borderRadius: 16, borderWidth: 1.5, gap: 6, overflow: 'hidden' },
  mapIcon: { fontSize: 28 },
  mapName: { fontFamily: 'Inter_700Bold', fontSize: 14 },
