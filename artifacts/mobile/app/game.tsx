...
const styles = StyleSheet.create({
  ...
  modeText: { fontFamily:'Exo2_700Bold', fontSize:12, letterSpacing:1.5 },
  ...
  timerText: { fontFamily:'Exo2_600SemiBold', fontSize:11, color:'#FFFFFF55', letterSpacing:0.8 },
  ballsBadge: { flexDirection:'row', alignItems:'center', gap:5 },
  ballDot: { width:7, height:7, borderRadius:4 },
  ballsText: { fontFamily:'Exo2_600SemiBold', fontSize:10, color:'#FFFFFF88', letterSpacing:0.5 },
  labelsRow:  { flexDirection:'row', paddingHorizontal:10, paddingBottom:2, alignItems:'center' },
  sideLabel:  { fontFamily:'Exo2_500Medium', fontSize:10, letterSpacing:0.5 },
  ...
  labelTxt: { fontFamily:'Exo2_600SemiBold', fontSize:11, letterSpacing:0.5 },
  ...
  livesLabel:  { fontFamily:'Exo2_500Medium', fontSize:9, color:'#FFFFFF44', letterSpacing:1, marginRight:2 },
  lifeHeart:   { width:10, height:10, borderRadius:5 },
  elimText:    { color:'#FF4757', fontFamily:'Exo2_700Bold', fontSize:11, letterSpacing:1 },
  ...
  extraLifeText: { color:'#FF69B4', fontFamily:'Exo2_600SemiBold', fontSize:11 },
  puRow:    { flexDirection:'row', gap:8 },
  puLegend: { flexDirection:'row', alignItems:'center', gap:3 },
  puDot:    { width:6, height:6, borderRadius:3 },
  puLabel:  { fontFamily:'Exo2_500Medium', fontSize:9, letterSpacing:0.3 },
  ...
  pauseTitle: { fontFamily:'Exo2_700Bold', fontSize:28, color:'#FFFFFF', letterSpacing:3 },
  ...
  pauseStatVal: { fontFamily:'Exo2_700Bold', fontSize:20, color:'#FFFFFF' },
  pauseStatLbl: { fontFamily:'Exo2_500Medium', fontSize:10, color:'#FFFFFF55', letterSpacing:1 },
  ...
  resumeText: { fontFamily:'Exo2_700Bold', fontSize:16, color:'#080814', letterSpacing:1 },
  quitBtn: { flexDirection:'row', alignItems:'center', gap:8, paddingVertical:6 },
  quitText: { fontFamily:'Exo2_500Medium', fontSize:13, color:'#FF475777' },
  ...
  lifeBtnText: { fontFamily:'Exo2_600SemiBold', fontSize:13, color:'#FF69B4' },
});
